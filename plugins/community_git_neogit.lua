...
return {
  {
    ...
    keys = {
      { prefix .. "t", "<cmd>Neogit<CR>", desc = "Open Neogit Tab Page" },
      { prefix .. "c", "<cmd>Neogit commit<CR>", desc = "Open Neogit Commit Page" },
      { prefix .. "d", ":Neogit cwd=", desc = "Open Neogit Override CWD" },
      { prefix .. "k", ":Neogit kind=", desc = "Open Neogit Override Kind" },
    },
  },
  {
    "catppuccin/nvim",
